...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ("v2", "agents"),
            None,
            "https://guidelight.dev/v2/agents?ordering=created",
        ),
        (
            "https://guidelight.dev?ordering=created",
            ("v2", "agents"),
            {"ordering": "modified"},
            "https://guidelight.dev/v2/agents?ordering=modified",
        ),
        (
            "https://guidelight.dev?ordering=created",
            ("v2", "agents"),
            {"include": "archives"},
            "https://guidelight.dev/v2/agents?ordering=created&include=archives",
        ),
    ],
)
